...
void __NOINLINE __libinteractive_init() {
	openstream(&__quicksort_in, "./quicksort_in", O_WRONLY);
	openstream(&__quicksort_out, "./quicksort_out", O_RDONLY);
}
...
int HacerParticion(int inicio, int fin) {
	...
	writefull(&__quicksort_in, &__msgid, sizeof(__msgid));
	writefull(&__quicksort_in, &inicio, sizeof(int));
	writefull(&__quicksort_in, &fin, sizeof(int));
	writefull(&__quicksort_in, &__cookie, sizeof(__cookie));
	writeflush(&__quicksort_in);
